...
export function ForWho() {
  return (
    <Section
      tone="surface"
      id="for-who"
      className="pt-16 pb-16 md:pt-20 md:pb-16"
    >
      ...
      >
        <div>
          ...
          <p className="mt-4 max-w-[480px] text-base leading-6 text-soft-2">
            Give your clients a new way to reach audiences beyond traditional
            media. adbox helps agencies deploy dynamic, location-aware campaigns
            across a growing network of mobile digital screens.
          </p>
