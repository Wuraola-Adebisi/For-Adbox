...
export function LiveNetwork() {
  return (
    <Section tone="ink" id="live-network" className="pb-[97px]">
      ...
      <div className="mt-[25.5px] flex flex-wrap items-baseline justify-between gap-x-6 gap-y-3">
        ...
        <p className="inline-flex items-center gap-2 text-[15px] font-medium text-muted">
          <span aria-hidden="true" className="size-2 rounded-full bg-dot-green" />
          Live · Lagos, Nigeria
        </p>
      </div>
      <p className="mt-[17.5px] max-w-[580px] text-base leading-6 text-muted">
        Our technology connects brands to a moving network of riders moving across various locations,
        delivering digital ads where your audience is most likely to see them.
      </p>
